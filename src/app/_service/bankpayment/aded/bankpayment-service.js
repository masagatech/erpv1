...
var bankpaymentService = (function () {
    function bankpaymentService(_dataserver, _router) {
        this._dataserver = _dataserver;
        this._router = _router;
    }
    bankpaymentService.prototype.getBankMaster = function (req) {
        return this._dataserver.post("BankNameGet", req);
    };
    bankpaymentService.prototype.saveBankPayment = function (req) {
        return this._dataserver.post("BankPaymentSave", req);
    };
    bankpaymentService.prototype.getBankPaymentView = function (req) {
