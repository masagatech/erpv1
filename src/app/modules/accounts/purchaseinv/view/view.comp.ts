...
export class purchaseinvview implements OnInit, OnDestroy {
    //Button 
    ...
    constructor(private _router: Router, private setActionButtons: SharedVariableService,
        private _autoservice: CommonService, private PurchaseServies: PurchaseService,
    ...
    actionBarEvt(evt) {
        if (evt === "add") {
            this._router.navigate(['/accounts/purchaseinv/add']);
        }
        if (evt === "save") {
