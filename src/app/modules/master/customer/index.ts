...
import { LazyLoadEvent, DataTableModule, CheckboxModule,AccordionModule } from 'primeng/primeng';
...
@NgModule({
    ...
    CommonModule, DataTableModule, CheckboxModule,AddDynamicTabModule,DynamicTabModule,AccordionModule],
    declarations: [
        CustAdd,
        CustView,
        //AddrbookComp,
